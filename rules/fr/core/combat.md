...
1. **Engagement.** Chaque joueur pose face cachée **une carte action 🎴** de cette bande — une seule — parmi celles qu'il peut payer. Le meneur fait de même pour chaque **adversaire** et chaque **horde**. Un combattant qui n'a rien à jouer dans cette bande **passe**.

   **Une carte par bande, au plus.** Un combattant engage donc au maximum **trois cartes par manche**, une par bande, et chaque bande impose un choix : soigner *ou* frapper, pas les deux.
