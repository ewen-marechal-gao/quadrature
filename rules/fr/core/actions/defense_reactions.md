...
**Affaiblir la Garde (X) :** certaines actions diminuent la valeur de Garde de X points.
...
**Réinitialisation :** un joueur peut dépenser une nouvelle **Réaction ⚡** pour effectuer un nouveau jet et modifier sa Garde.
...
⚠️ **Défaut :** augmentez votre Fatigue 💧 de 1 point.  
✴️ **Critique :** votre prochaine attaque contre l'attaquant bénéficie de +🟩.
