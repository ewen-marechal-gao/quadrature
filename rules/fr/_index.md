# Index — Règles de Quadrature (fr)

> Ce fichier est le point d'entrée de la version française des règles de Quadrature.  
> Chaque section renvoie vers les fichiers correspondants dans la structure `rules/fr/`.

---

## ⚙️ Règles fondamentales (`core/`)
...
## ⚔️ Disciplines (`disciplines/`)

### Martiales

| Fichier | Contenu |
| :--- | :--- |
| [disciplines/martial_escrime.md](disciplines/martial_escrime.md) | Escrime : 3 formes Tier-1, spécialisations Tier-2, bottes (Fente, Tailles et Estocs…) |
| [disciplines/martial_lames_courtes.md](disciplines/martial_lames_courtes.md) | Lames courtes : mécanique Engagement Serré, Tier-1 à Tier-3 |
| [disciplines/martial_hast.md](disciplines/martial_hast.md) | Armes d'Hast : Sentinelle, Piquier, Garde Longue, Phalange… |
| [disciplines/martial_archerie.md](disciplines/martial_archerie.md) | Archerie : Positionnement, Anticipation, Danse des cordes, Pluie de flèches |
| [disciplines/martial_tir_tendu.md](disciplines/martial_tir_tendu.md) | Tir tendu : mécanique ⚙️Recharger, 6 types de munitions, Tier-1 à Tier-2 |
| [disciplines/martial_arts_martiaux.md](disciplines/martial_arts_martiaux.md) | Arts martiaux : 🪷Posture Idéale, 4 styles (Offensif/Équilibré/Défensif/Chaotique), Tier-2 |
| [disciplines/martial_impact.md](disciplines/martial_impact.md) | Impact (WIP) : masses et haches, intentions de design |

### Magiques

| Fichier | Contenu |
| :--- | :--- |
| [disciplines/magie_intro.md](disciplines/magie_intro.md) | Introduction à la magie |
| [disciplines/magie_biomancie.md](disciplines/magie_biomancie.md) | Biomancie : soins, virulence, manipulation organique |
| [disciplines/magie_telepathie.md](disciplines/magie_telepathie.md) | Télépathie : lecture, influence, manipulation mentale |
| [disciplines/magie_electromancie.md](disciplines/magie_electromancie.md) | Électromancie : charges ⊕⊖, éclairs, champs électriques |
| [disciplines/magie_calomancie.md](disciplines/magie_calomancie.md) | Calomancie |
| [disciplines/magie_echomancie.md](disciplines/magie_echomancie.md) | Échomancie |
| [disciplines/magie_alchimie.md](disciplines/magie_alchimie.md) | Alchimie |
| [disciplines/magie_choromancie.md](disciplines/magie_choromancie.md) | Choromancie |
...
| Fichier | Contenu |
| :--- | :--- |
| [adversaires/regles_adversaires.md](adversaires/regles_adversaires.md) | Carte d'adversaire, dés d'adversaires, Niveau de Menace💀, actions & traits, règles Hordes |
| [adversaires/exemples_adversaires.md](adversaires/exemples_adversaires.md) | Fiches : Faible, Initié ; Horde de rats (exemple complet) |
